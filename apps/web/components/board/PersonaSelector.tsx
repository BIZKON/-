        ...
        {personas.map((persona) => {
          ...
          return (
            <div
              ...
              aria-label={`Select advisor: ${persona.name}`}
              className={cn(
                "relative p-4 rounded-xl border-2 cursor-pointer transition-all outline-none focus-visible:ring-2 focus-visible:ring-blue-500",
                isSelected
