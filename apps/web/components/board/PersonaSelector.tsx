        ...
        {personas.map((persona) => {
          ...
          return (
            <div
              ...
              className={cn(
                "relative p-4 rounded-xl border-2 cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2",
                isSelected
