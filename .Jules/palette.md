...
## 2024-05-23 - Card-Form Pattern
**Learning:** Form inputs nested in Cards visually borrow their labels from the Card Title, but this connection is invisible to screen readers.
**Action:** Use `aria-labelledby` linking to the Card Title ID and `aria-describedby` linking to the Card Description ID.
